...
CFG.ShanFL.initial_trust_score = 1.0
CFG.ShanFL.consistency_threshold = 0.85
CFG.ShanFL.trust_increase_factor = 1.05
CFG.ShanFL.trust_decrease_factor = 0.95
CFG.ShanFL.min_trust_score = 0.0
CFG.ShanFL.max_trust_score = 1.0  
